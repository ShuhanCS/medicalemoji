...
| `Gut` does not map cleanly to a single intestine glyph. | Merriam-Webster, https://www.merriam-webster.com/dictionary/gut | `Gut` may mean the digestive tract or part of it, belly, courage, or intuition. | Internal stress test only; Candidate.9 preserves the positive boundary and does not introduce gut or intestine in the reviewer-facing Open-ended answer. |
