...
Packet version: `1.12.0-candidate.5`
...
| Proposal structure and advocate edit | Pass for candidate | Current 2026 factor order, sourced concrete meanings, three single-reading sequences, direct substitute rebuttal, clear open-ended boundary, and concise `Not applicable` factors. |
...
| Readiness panel | Pending rerun | Run the five-seat panel on the rebuilt `1.12.0-candidate.5` PDF hash. |
