...
## 1. Article (for the website)

A complete, publication-ready article written for an informatics audience.

- **Read / preview (styled):** https://medicalemoji.org/press/acep/medical-emoji-acep-article.html
- **PDF:** https://medicalemoji.org/press/acep/medical-emoji-acep-article.pdf
- **Markdown source:** `docs/acep-press-kit/article.md`
- **Paste-ready HTML body** (drop into the CMS): `docs/acep-press-kit/article-body.html`
...
A tall, branded infographic covering the story, the ten concepts, and the ACEP quote.

- **Full resolution (print/social):** https://medicalemoji.org/press/acep/medical-emoji-infographic.png
- **Web-optimized (1200px wide):** https://medicalemoji.org/press/acep/medical-emoji-infographic-web.png
...
<p style="font-size:13px;color:#666;margin-top:8px;">
  ...
  <a href="https://medicalemoji.org" target="_blank" rel="noopener">Medical Emoji Project</a>.
</p>
```
...
concept are in the insights sheet:
