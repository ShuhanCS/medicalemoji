# Outreach Kit — Helen Burstin, MD, MPH, MACP (National Academy of Medicine)

**Purpose:** Ask Dr. Burstin to lend her national standing — through the National
Academy of Medicine (NAM) and her network — to the Medical Emoji effort, and to help
open doors to anyone she knows on the Unicode Consortium so we can seek their support
ahead of the 2026 submission window.

**Prepared for:** Shuhan He, MD — medicalemoji.org
**Companion to:** the CMSS outreach kit for Clifford Hudis, MD (President, CMSS / CEO, ASCO)
**Status:** Draft for Shuhan's review and personalization before sending.

> Note on relationship framing: Dr. Burstin is also CEO of the Council of Medical
> Specialty Societies (CMSS), so there is natural overlap with the Hudis/CMSS ask. This
> kit leads with her **NAM / national-presence** role per your direction and keeps her as
> a personal mentor contact, not a cold organizational ask. Adjust the warmth to match
> your actual relationship.

---

## 1. Who she is (for talking points)

- **Helen Burstin, MD, MPH, MACP** — Chief Executive Officer, Council of Medical
  Specialty Societies (CMSS), the coalition of 50+ specialty societies representing
  800,000+ physicians.
- **Elected member of the National Academy of Medicine (NAM).**
- Former Chief Scientific Officer, National Quality Forum (NQF); former Director of the
  Center for Primary Care, Prevention, and Clinical Partnerships at AHRQ; former Harvard
  Medical School faculty and Director of Quality Measurement at Brigham and Women's.
- Mastership in the American College of Physicians; 100+ articles on quality, safety,
  equity, and measurement.

**Why she is the right person for this ask:** national convening power, deep credibility
on measurement and standards, and a network that spans federal quality bodies, specialty
societies, and academic medicine — exactly the institutional weight a Unicode proposal
benefits from in its letters of support.

---

## 2. The two asks (keep them simple)

1. **A letter / statement of support with national reach.** A short NAM-affiliated or
...
## 3. Key dates (put these in the email)
...
Framing line for the email: *"To land before World Emoji Day on July 17 and our
August 1 deadline, I'd love to have anything you're comfortable lending by mid-July."*

---

## 4. Unicode — who to ask about (list to share with her)

Below is the current Unicode leadership and emoji-review structure, so Dr. Burstin can see
at a glance whether she has any connection worth tapping. **Please verify each name and
title against unicode.org/consortium before sending** — these change and Unicode blocks
automated lookups, so this list is from public reporting and should be double-checked.

### People who actually review emoji proposals (most relevant)
- **Jennifer Daniel** — Chair, Emoji Standard & Research Working Group (ESR, formerly the
  Emoji Subcommittee). The single most relevant decision-influencing role; reviews and
  shepherds proposals. (Background: artist/designer, formerly Google.)
- **Jennifer 8. Lee** — Vice-Chair, Emoji Subcommittee; founder of **Emojination**
  ("emoji by the people, for the people"), the grassroots group behind many successful
  proposals. The most likely productive door for coalition support.

### Unicode Consortium executive leadership
- **Toral Cowieson** — Chief Executive Officer.
...
> **To:** Helen Burstin <hburstin@cmss.org> *(verify address)*
> **Subject:** A small ask with national reach — medical emoji, before World Emoji Day

Dear Helen,

Thank you again for your mentorship — it genuinely shapes how I think about doing this
work at a national level. I'm writing with a small, time-bound ask I think is right in
your wheelhouse.
...
1. **Your voice with national reach.** A short statement — under your NAM standing or your
   own name, whichever you're comfortable with — that medical emoji are a serious
...
closes July 31). If you're open to it, anything you could lend by mid-July would be
perfect.

I'm happy to draft language for your review, keep it as light or as formal as you prefer,
and make it completely turnkey for you. Thank you for considering it — and for everything.
...
## 6. Background one-pager (attach or paste if she wants detail)

- **Precedent:** Anatomical heart 🫀 and lungs 🫁 approved in Emoji 13.0 (2020) after a
  medical-emoji proposal led by Shuhan He, MD; implemented by Apple in iOS 14.2. Covered by
  the *Boston Globe* and *The Verge*.
- **Peer-reviewed basis:** Lai D, Lee J, He S. "Emoji for the Medical Community —
  Challenges and Opportunities." *JAMA.* 2021;326(9):795-796. And: He S, et al. "Comparison
  of an Emoji-Based Visual Analog Scale With a Numeric Rating Scale for Pain Assessment."
  *JAMA.* 2022;328(2):208-209.
- **Why it matters clinically:** plain-language patient education, telehealth,
  cross-language communication, and public-health messaging — interoperable, standardized
  symbols that work across every phone, portal, and platform.
- **Coalition to date:** physician-society and patient-organization letters across the six
  proposed concepts; ACEP as the first national multi-specialty society endorser.
- **The ask in one line:** a national-academy-level voice of support, plus any personal
  door to Unicode, in time for World Emoji Day (July 17) and our August 1 deadline.
...
- Helen Burstin (CMSS bio): https://cmss.org/team/helen-burstin/

---

*Verify all names, titles, and email addresses before sending. Unicode roster compiled
from public reporting (June 2026) because unicode.org blocks automated retrieval —
confirm against the official consortium pages.*
