...
| 4 | Maze | Re-eligible; declined twice | Four Google captures missing | Iconic mouse-maze paradigm; puzzle, path, learning, memory, research, and navigation meanings | Two prior declines; current Ngram approximately 0.67x `elephant` | Evidence reserve |
...
- **Maze:** preserve the mouse navigating broad corridors. Lead with concrete puzzle, path, learning, memory,
  research, choice, complexity, and escape uses rather than a neuroscience-awareness cause.
