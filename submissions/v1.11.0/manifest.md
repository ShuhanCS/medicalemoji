# Medical Emoji Submission Package v1.11.0

Package version: 1.11.0

Created: 2026-07-26

Status: **Stomach artwork corrected; package remains in review and is not yet filed.**
...
| Component | Component version/provenance | Status in v1.11.0 |
| --- | --- | --- |
...
| Stomach | Submission package v1.11.0 | Artwork, proposal language, readiness record, and PDF corrected; evidence refresh and recognition review remain open |
...
The next substantive proposal correction after this snapshot will therefore create `submissions/v1.12.0/` by
copying all of v1.11.0 and changing only the reviewed proposal plus package control files.
...
- Kidney: publish the byte-identical Kidney PDF carried into v1.11.0, reconcile the form, obtain final filing
  authorization, and archive the submission confirmation.
