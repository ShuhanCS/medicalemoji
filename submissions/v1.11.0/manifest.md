...
| --- | --- | --- |
| Ideal proposal template | Template 1.0.0 from v1.10.0 | Carried forward byte for byte |
| Best-in-class rubric | Rubric 3.0.0 | Synchronized to the current 17-section approval guide |
| White Blood Cell | Submission package v1.11.0 | Artwork, validation, current Trends/Ngram evidence, author list, and affirmative proposal source updated |
...
| Artwork license | Package v1.11.0 | White Blood Cell rights statement updated; other art carried forward |
...
This snapshot copies v1.10.0 and changes only the White Blood Cell component, the current approval rubric, and
