...
Readiness record version: 1.0.0

Date: 2026-07-26

Proposal package: 1.11.0
...
| Distinctiveness | Pass | Names stable visible cues, nearest visual alternatives, 18-pixel separation, and vendor freedom in ordinary language. |
| Expected usage level | Pass | Synthesizes routine testing, immune response, treatment monitoring, education, and research with institutional citations and five-source evidence. |
...
| Already represented | Pass | Addresses the strongest substitute, Microbe + Shield, and the meanings it cannot express. |
| Overly specific | Pass | Defines the broad leukocyte category and excludes subtypes, diseases, procedures, and campaigns. |
| Open-ended | Pass | Names Red Blood Cell, Platelet, generic Cell, and leukocyte subtypes and gives an independent limiting principle. |
