# Medical Emoji Submission Package v1.13.0
...
| Component | Component version/provenance | Status in v1.13.0 |
| --- | --- | --- |
...
| White Blood Cell | Submission package v1.13.0 | Reviewer-facing OpenMoji material removed; proposed artwork remains original Medical Emoji work; internal comparator QA retained |
...
| Artwork license | Package v1.13.0 | Image rights unchanged; White Blood Cell art carried forward from v1.12.0 |
...
This snapshot copies v1.12.0 and changes only the reviewer-facing White Blood Cell proposal and PDF, rubric,
helper usage examples, and package control files. Pinned comparator assets remain internal and unchanged.
