...
- Applied lesson: the v1.13.0 proposal leads with the missing host immune cell and white-cell-count meanings,
  uses direct `Not applicable.` answers, limits frequency comparisons to their evidentiary purpose, and removes
  generic case-building phrases.
...
| ESR selection reviewer | READY FOR FINAL CHECK | The proposal defines a concrete host-immune-cell gap, interprets frequency evidence proportionately, and uses genuine `Not applicable.` answers. |
| Community proposal mentor | READY FOR FINAL CHECK | An educated general reader can follow the ordinary communication uses without a cause, prestige, or set-completion argument. |
...
Shuhan He's prior approval and rights confirmation governs the unchanged four-artwork set carried from v1.12.0.
...
- Hyperlinks: 12 unique HTTPS destinations embedded.
...
- PDF SHA-256: `B4C94E57708AA35B4AF1933C6C2F7D65C640F448C2D18A996680CB28C29816F8`.

## Publication record

Release commit: `2dbefc48466f4e865d3313020b0772fbf46fdb4e`
...
Logged-out verification: HTTP 200, `application/octet-stream`, 1,530,280 bytes; downloaded SHA-256 matches the
