...
python scripts/validate_white_blood_cell_artwork.py `
  --proposal-dir submissions/v1.13.0/white-blood-cell `
  --json-output submissions/v1.13.0/white-blood-cell/validation/computer-validation.json `
  --markdown-output submissions/v1.13.0/white-blood-cell/validation/computer-validation.md
```
