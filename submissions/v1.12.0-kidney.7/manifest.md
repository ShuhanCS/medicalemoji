# Medical Emoji Submission Package v1.12.0-kidney.7

Package version: 1.12.0-kidney.7
...
| Component | Component version/provenance | Status in v1.12.0-kidney.7 |
| --- | --- | --- |
...
| Kidney | Prerelease v1.12.0-kidney.7 | Ten-author byline preserved; 18px pair rebuilt as solid notched bodies; Multiple meanings claimed via `kidney-shaped`; Already representable led by observed Beans substitution; all fixed computer checks pass |
...
| Artwork license | Package 1.12.0-kidney.7 | Kidney GPT Image 2 masters and exact exports plus Stomach artwork provenance recorded |

Folder layout:

```text
submissions/v1.12.0-kidney.7/
|-- VERSION
|-- manifest.md
|-- CHANGELOG.md
|-- ARTWORK-LICENSE.md
...
specification. A further Kidney-only iteration creates `submissions/v1.12.0-kidney.8/`; accepted Kidney changes
...
- Kidney: obtain Shuhan's approval of the exact `.6` assets, archive eligibility and
  duplicate-coordination evidence, publish the exact PDF, reconcile
