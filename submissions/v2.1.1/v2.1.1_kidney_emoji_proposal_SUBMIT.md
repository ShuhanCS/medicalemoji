...
![Kidney color 18x18](images/v2.1.1_kidney_color_18x18_SUBMIT.png)

Color 72x72:

![Kidney color 72x72](images/v2.1.1_kidney_color_72x72_SUBMIT.png)

Black-and-white 18x18:

![Kidney black-and-white 18x18](images/v2.1.1_kidney_bw_18x18_SUBMIT.png)

Black-and-white 72x72:

![Kidney black-and-white 72x72](images/v2.1.1_kidney_bw_72x72_SUBMIT.png)
...
The kidney has a distinctive anatomical form: a curved organ shape, a medial indentation or hilum, and a vessel or ureter cue. The example uses one large, simplified organ so the core silhouette and a non-food anatomical cue remain clear at 18x18.
...
![Kidney 18x18 visual review board](evidence/visual-review/v2.1.1_18x18_visual_review_board_SUBMIT.png)

The current single-kidney image is the preferred direction because it gives one organ most of the 18x18 frame. Its visible hilum and short ureter cue distinguish it from a bean or generic red shape.
...
| Does it work at 18x18? | The included board shows the native-size candidate beside bean-like and generic-organ comparators, highlighting the kidney's single silhouette, medial hilum, and urinary-system cue. |
...
![Google Trends Web Search: elephant versus kidney](evidence/frequency/v2.1.1_frequency_google_trends_web_elephant_kidney_2026-05-13_SUBMIT.png)

Figure 4. Google Trends Image Search, `elephant` versus `kidney`:

![Google Trends Image Search: elephant versus kidney](evidence/frequency/v2.1.1_frequency_google_trends_image_elephant_kidney_2026-05-13_SUBMIT.png)
...
Kidney would fill a practical communication gap without opening an anatomy taxonomy. It combines high term frequency, broad ordinary-language use, distinct body-function and health meaning, a visually distinctive paradigm, and a clear failure of existing substitutes.
...
| Visually distinctive | A single kidney shape, medial hilum, and short urinary-system cue are shown at 18x18 beside bean-like and generic-organ comparators. |
