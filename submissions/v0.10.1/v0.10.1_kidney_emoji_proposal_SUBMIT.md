...
Status: `PLANNED_FOR_SUBMISSION`. This proposal source is intended to become the public Unicode PDF after final evidence recapture, submitter approval, and PDF hosting.
...
![Kidney color 18x18](images/v0.10.1_kidney_color_18x18_SUBMIT.png)

Color 72x72:

![Kidney color 72x72](images/v0.10.1_kidney_color_72x72_SUBMIT.png)

Black-and-white 18x18:

![Kidney black-and-white 18x18](images/v0.10.1_kidney_bw_18x18_SUBMIT.png)

Black-and-white 72x72:

![Kidney black-and-white 72x72](images/v0.10.1_kidney_bw_72x72_SUBMIT.png)
...
Suggested keywords: renal; organ; anatomy; body; urine; filtration; hydration; kidney bean; kidney-shaped; kidney stone; kidney health; nephrology; dialysis; transplant; donation; kidney disease; chronic kidney disease; acute kidney injury
...
| Image | Source file | Repository link |
| --- | --- | --- |
| Color 18x18 | `images/v0.10.1_kidney_color_18x18_SUBMIT.png` | https://github.com/ShuhanCS/medicalemoji/blob/master/submissions/v0.10.1/images/v0.10.1_kidney_color_18x18_SUBMIT.png |
| Color 72x72 | `images/v0.10.1_kidney_color_72x72_SUBMIT.png` | https://github.com/ShuhanCS/medicalemoji/blob/master/submissions/v0.10.1/images/v0.10.1_kidney_color_72x72_SUBMIT.png |
| Black-and-white 18x18 | `images/v0.10.1_kidney_bw_18x18_SUBMIT.png` | https://github.com/ShuhanCS/medicalemoji/blob/master/submissions/v0.10.1/images/v0.10.1_kidney_bw_18x18_SUBMIT.png |
| Black-and-white 72x72 | `images/v0.10.1_kidney_bw_72x72_SUBMIT.png` | https://github.com/ShuhanCS/medicalemoji/blob/master/submissions/v0.10.1/images/v0.10.1_kidney_bw_72x72_SUBMIT.png |
| Source artwork copy | `images/v0.10.1_kidney_artwork_SOURCE_REFERENCE_ONLY.png` | https://github.com/ShuhanCS/medicalemoji/blob/master/submissions/v0.10.1/images/v0.10.1_kidney_artwork_SOURCE_REFERENCE_ONLY.png |

Source artwork copy:

![Kidney source artwork copy](images/v0.10.1_kidney_artwork_SOURCE_REFERENCE_ONLY.png)
...
Kidney plus water drop could represent hydration, urine production, filtration, dehydration, or kidney function. Kidney plus cooking pot, bowl, or beans could represent kidney beans, recipes, chili, meal planning, or nutrition, while still leaving the existing bean emoji available for generic beans. Kidney plus school, microscope, or book could represent anatomy education or science class. Kidney plus person could represent the human body, a donor, recipient, patient, clinician, caregiver, or family member. Kidney plus hospital could represent a nephrology appointment, hospitalization for kidney disease, or kidney care. Kidney plus pill could represent medication safety, kidney-protective treatment, or medications that require kidney-function monitoring. Kidney plus syringe could represent laboratory testing, biopsy, treatment, transplant preparation, or post-transplant care. Kidney plus warning sign could represent kidney stones, urgent symptoms, abnormal kidney-function tests, nephrotoxic medication risk, or acute kidney injury.
...
https://github.com/ShuhanCS/medicalemoji/blob/master/submissions/v0.10.1/evidence/visual-review/v0.10.1_18x18_visual_review_board_REFERENCE_ONLY.png

![Kidney 18x18 visual review board](evidence/visual-review/v0.10.1_18x18_visual_review_board_REFERENCE_ONLY.png)
...
Required evidence status for this planned submission:

| Evidence | URL | Current status |
| --- | --- | --- |
| Google Search | https://www.google.com/search?q=kidney | Required final recapture: automated capture returned CAPTCHA on 2026-05-13. |
| Google Video Search | https://www.google.com/search?tbm=vid&q=kidney | Required final recapture: automated capture returned CAPTCHA on 2026-05-13. |
| Google Trends Web Search | https://trends.google.com/trends/explore?date=all&q=elephant,kidney | Captured as usable draft evidence on 2026-05-13. |
...
Current frequency evidence images are archived here:

https://github.com/ShuhanCS/medicalemoji/tree/master/submissions/v0.10.1/evidence/frequency

Figure 1. Google Trends Web Search, `elephant` versus `kidney`:

![Google Trends Web Search: elephant versus kidney](evidence/frequency/v0.10.1_frequency_google_trends_web_elephant_kidney_2026-05-13_REFERENCE_ONLY.png)

Figure 2. Google Trends Image Search, `elephant` versus `kidney`:

![Google Trends Image Search: elephant versus kidney](evidence/frequency/v0.10.1_frequency_google_trends_image_elephant_kidney_2026-05-13_REFERENCE_ONLY.png)

Figure 3. Google Books Ngram Viewer, `elephant` versus `kidney`:

![Google Books Ngram: elephant versus kidney](evidence/frequency/v0.10.1_frequency_google_books_ngram_elephant_kidney_2026-05-13_REFERENCE_ONLY.png)

The final public PDF must insert fresh accepted screenshots for all five required evidence categories before filing. Google Search and Google Video Search screenshots are absent because automated capture returned CAPTCHA pages. Support letters, petitions, hashtags, and social-media requests are not used as frequency evidence.
...
The Medical Emoji project has recovered public support materials from nephrology, patient-advocacy, and kidney-health organizations. These letters demonstrate expert and patient-advocacy support, but the expected-usage case relies on the required frequency evidence above. The letters are coalition context and may be included as optional appendix links after permission is confirmed.

Support-letter map:
https://github.com/ShuhanCS/medicalemoji/blob/master/docs/proposals/support-letter-link-map.md

Recovered support-letter links:
...
https://github.com/ShuhanCS/medicalemoji/tree/master/submissions/v0.10.1

Final public proposal PDF URL: `TBD`

### E. Link Appendix

Medical Emoji Kidney page:
...
https://github.com/ShuhanCS/medicalemoji/blob/master/submissions/v0.10.1/v0.10.1_kidney_emoji_proposal_SUBMIT.md

Current source manifest:
https://github.com/ShuhanCS/medicalemoji/blob/master/submissions/v0.10.1/manifest.md
