...
Important draft note: this Markdown draft uses the owned Medical Emoji kidney artwork, but still contains placeholders where the final Unicode PDF must include usage-frequency screenshots, final submitter approvals, final visual review, and a public PDF URL. The final submitted proposal must remove this note.
...
| --- | --- |
| Color 18x18 | `images/v0.4.0_kidney_color_18x18_REFERENCE_ONLY.png` |
| Color 72x72 | `images/v0.4.0_kidney_color_72x72_REFERENCE_ONLY.png` |
| Black-and-white 18x18 | `images/v0.4.0_kidney_bw_18x18_REFERENCE_ONLY.png` |
| Black-and-white 72x72 | `images/v0.4.0_kidney_bw_72x72_REFERENCE_ONLY.png` |
