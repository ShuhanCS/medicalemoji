...
- Liver + Fork and Knife: “Liver is on the menu.”
...
FAO/Codex classifies liver as edible offal fit for human consumption, supporting the food message as a
separate everyday use of the same organ image.

Sources:

- [MedlinePlus: Liver Function Tests](https://medlineplus.gov/lab-tests/liver-function-tests/)
- [FAO/Codex: Classification of Food and Food Groups](https://www.fao.org/4/x5848e/X5848e0b.htm)

### C. Breaks new ground

**Yes.** Test Tube can say “test,” Pill + Warning can say “medicine risk,” and Fork and Knife can say “meal,”
but none can say liver. Cut of Meat can suggest meat in general, but not the recognizable whole organ. Liver
supplies the missing subject in anatomy, food, and the cited health messages.
...
Liver is a common standalone term for a recognizable organ in anatomy and biology, an ingredient in food and
cooking, and the subject of health messages about testing, medicine effects, transplantation, and donation.
MedlinePlus documents its anatomy and test uses, FAO/Codex classifies liver as edible offal, and NIDDK documents
liver transplantation and living donors. The five required figures below measure the standalone term across
these uses: they show worldwide Web interest comparable to `elephant`, lower but sustained worldwide Image
Search interest, and substantially higher recent English-language published-word frequency.

Sources:

- [MedlinePlus: Liver Function Tests](https://medlineplus.gov/lab-tests/liver-function-tests/)
- [MedlinePlus: Liver Anatomy](https://medlineplus.gov/ency/imagepages/8848.htm)
- [FAO/Codex: Classification of Food and Food Groups](https://www.fao.org/4/x5848e/X5848e0b.htm)
...
Test Tube can say “test,” Pill + Warning can say “medicine risk,” and Fork and Knife can say “meal.” Cut of Meat
can suggest meat in general. None identifies liver directly, so each loses the subject of the cited message.
...
Liver crosses three documented domains: a recognizable organ in anatomy, edible offal in food, and the subject
of testing, medicine, and transplantation messages. The same whole-organ image names the subject in each domain.
The proposal does not encode every related body part, food, test, disease, medicine effect, or procedure, and it
does not depend on completing an anatomy set.

### D. Transient

Liver is not tied to a campaign, event, or temporary technology. The English-language Ngram tracks the word
through 1500-2022; MedlinePlus uses it for anatomy and tests, FAO/Codex for food, and NIDDK for transplantation.
