...
Promotion note: this is the historical review record for the v1.13 candidate. The exact-art approval and
coauthor-consent gates listed as open below were closed on 2026-07-27 before byte-identical promotion to
`submissions/v2.3.0/`. Packet v2.3.1 later added verified Microsoft titles; v2.4.0 restructured the public
proposal for the May 2026 template and added the CLDR interoperability case; v2.4.1 compressed the PDF layout;
v2.4.2 records final submitter readiness decisions. The findings below remain a historical record, not a review
of v2.4.2.
