# Medical Emoji Submission Package v1.12.0-kidney.4

Package version: 1.12.0-kidney.4

Created: 2026-07-26

Status: **Isolated Kidney case-built prerelease; NOT READY TO SUBMIT.**
...
| Component | Component version/provenance | Status in v1.12.0-kidney.4 |
| --- | --- | --- |
...
| Best-in-class rubric | Rubric 3.3.0 | Current section-by-section drafting, exact-asset approval, and SemVer controls recorded |
| White Blood Cell | Submission package v1.9.0 | Complete folder carried forward byte for byte; evidence-gated draft |
| Kidney | Prerelease v1.12.0-kidney.4 | Ten-author byline preserved; case brief and claim ledger complete; proposal rebuilt around observed Kidney-specific messages; purpose-built 18x18 assets pass all fixed computer checks |
...
| Artwork license | Package 1.12.0-kidney.4 | Kidney and Stomach AI-assisted concept provenance and project-authored submission assets recorded |

Folder layout:

```text
submissions/v1.12.0-kidney.4/
|-- VERSION
|-- manifest.md
|-- CHANGELOG.md
|-- ARTWORK-LICENSE.md
...
2. Kidney - Shuhan He; Edgar Lerma; Caitlyn Vlasschaert; Jade M. Teakell; Harish Seethapathy; Jarone Lee;
   Danielle Miller; Timur Erk; David Rhew, MD (Microsoft); Heena Purohit (Microsoft for Startups).
...
specification. A further Kidney-only iteration creates `submissions/v1.12.0-kidney.4/`; accepted Kidney changes
...
- Kidney: obtain Shuhan's approval of the exact revised 18x18 assets, archive eligibility and
  duplicate-coordination evidence, complete the exact-hash independent panel, publish the exact PDF, reconcile
  the form, and promote the accepted paired artwork into a canonical snapshot.
