...
Case-brief version: 1.0.0

Review date: 2026-07-26

Active package: `1.12.0-kidney.4`
...
| Real-message | `PASS` | Every retained use is an established patient-facing phrase or instruction in NIDDK, MedlinePlus, or HRSA guidance; speculative hydration, medication, caregiver, and awareness uses were removed. |
...
| Transient | 1500-2022 Books evidence and current NIDDK, MedlinePlus, and HRSA terminology | `PASS` |
