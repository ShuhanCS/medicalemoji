...
python scripts/validate_kidney_artwork.py `
  --proposal-dir submissions/v1.12.0-kidney.4/kidney `
  --json-output submissions/v1.12.0-kidney.4/kidney/validation/computer-validation.json `
  --markdown-output submissions/v1.12.0-kidney.4/kidney/validation/computer-validation.md
```
