...
https://github.com/ShuhanCS/medicalemoji/tree/feat/microsoft-round-strategy/submissions/v1.2.0/liver/images
...
Liver is a familiar body part with uses across anatomy, digestion, metabolism, health, food, testing, donation, and transplant. It supports ordinary messages about liver function, laboratory results, medication effects, alcohol, hepatitis, fatty liver, transplant, living donation, school science, animal liver as food, and family health.

The concept crosses clinical and everyday contexts. People discuss liver health when reviewing tests or medications, talking about alcohol, making diet choices, caring for relatives, learning biology, or preparing food. A liver pictograph identifies the organ directly, where hospital, pill, warning, food, or beverage emoji each show only one surrounding context.
...
The required evidence covers general web results, video results, long-term web interest, image-search interest, and published-book usage. Google Trends and Google Books compare `liver` with Unicode's reference term `elephant`.
...
| Google Trends Web Search | United States, 2004-present; liver and elephant show comparable average interest in the captured period; captured 2020-07-12 | https://trends.google.com/trends/explore?date=all&geo=US&q=liver,elephant |
| Google Trends Image Search | United States, 2008-present; sustained liver image-search interest; captured 2020-07-12 | https://trends.google.com/trends/explore?date=all_2008&geo=US&gprop=images&q=liver,elephant |
...
![Google Search results for liver](evidence/frequency/liver_google_search_2020-07-12_SUBMIT.png)

**Google Video Search**

![Google Video Search results for liver](evidence/frequency/liver_google_video_search_2020-07-12_SUBMIT.png)

**Google Trends - Web Search**

![Google Trends Web Search for liver and elephant](evidence/frequency/liver_google_trends_web_elephant_2020-07-12_SUBMIT.png)

**Google Trends - Image Search**

![Google Trends Image Search for liver and elephant](evidence/frequency/liver_google_trends_image_elephant_2020-07-12_SUBMIT.png)
