...
![Kidney color 18x18](images/v1.2.0_kidney_color_18x18_SUBMIT.png)

Color 72x72:

![Kidney color 72x72](images/v1.2.0_kidney_color_72x72_SUBMIT.png)

Black-and-white 18x18:

![Kidney black-and-white 18x18](images/v1.2.0_kidney_bw_18x18_SUBMIT.png)

Black-and-white 72x72:

![Kidney black-and-white 72x72](images/v1.2.0_kidney_bw_72x72_SUBMIT.png)

### Image License And Rights

The color and black-and-white kidney example artwork was created for the Medical Emoji project from its original vector source. Conductscience Foundation will confirm its authority to grant the rights required for use in this Unicode emoji proposal before filing.

The example images are proposal reference artwork, not a request for exact vendor art. The submitter will confirm final authorization and agree to the Unicode Emoji Proposal Agreement and License before filing:
...
![Kidney 18x18 visual review board](evidence/visual-review/v1.2.0_18x18_visual_review_board_SUBMIT.png)
...
![Google Search: kidney](evidence/frequency/v1.2.0_frequency_google_search_kidney_2026-05-13_SUBMIT.png)

Figure 2. Google Video Search results for `kidney`:

![Google Video Search: kidney](evidence/frequency/v1.2.0_frequency_google_video_search_kidney_2026-05-13_SUBMIT.png)

Figure 3. Google Trends Web Search, `elephant` versus `kidney`:

![Google Trends Web Search: elephant versus kidney](evidence/frequency/v1.2.0_frequency_google_trends_web_elephant_kidney_2026-05-13_SUBMIT.png)

Figure 4. Google Trends Image Search, `elephant` versus `kidney`:

![Google Trends Image Search: elephant versus kidney](evidence/frequency/v1.2.0_frequency_google_trends_image_elephant_kidney_2026-05-13_SUBMIT.png)

Figure 5. Google Books Ngram Viewer, `elephant` versus `kidney`:

![Google Books Ngram: elephant versus kidney](evidence/frequency/v1.2.0_frequency_google_books_ngram_elephant_kidney_2026-05-13_SUBMIT.png)
