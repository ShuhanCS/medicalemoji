...
| --- | --- | --- |
| 18x18 | ![Kidney color 18x18](images/v2.5.0_kidney_color_18x18_SUBMIT.png) | ![Kidney black-and-white 18x18](images/v2.5.0_kidney_bw_18x18_SUBMIT.png) |
| 72x72 | ![Kidney color 72x72](images/v2.5.0_kidney_color_72x72_SUBMIT.png) | ![Kidney black-and-white 72x72](images/v2.5.0_kidney_bw_72x72_SUBMIT.png) |
...
They test the unfiltered term `kidney` in Google Search, Google Video Search, Google Trends Web Search, Google
Trends Image Search, and Google Books Ngram Viewer. The Trends and Books exhibits compare `kidney` with
`elephant` as instructed. Together, they show sustained current and historical use of the term. Because the
unfiltered term also captures `kidney bean` and disease-related pages, the data establishes term visibility;
it does not claim medical importance or guarantee future emoji use.
...
![Google Search results for kidney](evidence/frequency/v2.5.0_kidney_google_search_2026-05-13_SUBMIT.png)
...
![Google Video Search results for kidney](evidence/frequency/v2.5.0_kidney_google_video_search_2026-05-13_SUBMIT.png)
...
![Google Trends Web Search for elephant and kidney](evidence/frequency/v2.5.0_kidney_google_trends_web_elephant_2026-05-13_SUBMIT.png)
...
![Google Trends Image Search for elephant and kidney](evidence/frequency/v2.5.0_kidney_google_trends_image_elephant_2026-05-13_SUBMIT.png)
...
![Google Books Ngram for elephant and kidney](evidence/frequency/v2.5.0_kidney_google_books_ngram_elephant_2026-07-09_SUBMIT.png)
