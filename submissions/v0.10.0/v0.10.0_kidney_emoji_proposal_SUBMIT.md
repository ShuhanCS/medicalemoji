...
![Kidney color 18x18](images/v0.10.0_kidney_color_18x18_SUBMIT.png)

Color 72x72:

![Kidney color 72x72](images/v0.10.0_kidney_color_72x72_SUBMIT.png)

Black-and-white 18x18:

![Kidney black-and-white 18x18](images/v0.10.0_kidney_bw_18x18_SUBMIT.png)

Black-and-white 72x72:

![Kidney black-and-white 72x72](images/v0.10.0_kidney_bw_72x72_SUBMIT.png)
...
| --- | --- | --- |
| Color 18x18 | `images/v0.10.0_kidney_color_18x18_SUBMIT.png` | https://github.com/ShuhanCS/medicalemoji/blob/master/submissions/v0.10.0/images/v0.10.0_kidney_color_18x18_SUBMIT.png |
| Color 72x72 | `images/v0.10.0_kidney_color_72x72_SUBMIT.png` | https://github.com/ShuhanCS/medicalemoji/blob/master/submissions/v0.10.0/images/v0.10.0_kidney_color_72x72_SUBMIT.png |
| Black-and-white 18x18 | `images/v0.10.0_kidney_bw_18x18_SUBMIT.png` | https://github.com/ShuhanCS/medicalemoji/blob/master/submissions/v0.10.0/images/v0.10.0_kidney_bw_18x18_SUBMIT.png |
| Black-and-white 72x72 | `images/v0.10.0_kidney_bw_72x72_SUBMIT.png` | https://github.com/ShuhanCS/medicalemoji/blob/master/submissions/v0.10.0/images/v0.10.0_kidney_bw_72x72_SUBMIT.png |
| Source artwork copy | `images/v0.10.0_kidney_artwork_SOURCE_REFERENCE_ONLY.png` | https://github.com/ShuhanCS/medicalemoji/blob/master/submissions/v0.10.0/images/v0.10.0_kidney_artwork_SOURCE_REFERENCE_ONLY.png |

Source artwork copy:

![Kidney source artwork copy](images/v0.10.0_kidney_artwork_SOURCE_REFERENCE_ONLY.png)
...
https://github.com/ShuhanCS/medicalemoji/blob/master/submissions/v0.10.0/evidence/visual-review/v0.10.0_18x18_visual_review_board_REFERENCE_ONLY.png

![Kidney 18x18 visual review board](evidence/visual-review/v0.10.0_18x18_visual_review_board_REFERENCE_ONLY.png)
...
https://github.com/ShuhanCS/medicalemoji/tree/master/submissions/v0.10.0/evidence/frequency

Figure 1. Google Trends Web Search, `elephant` versus `kidney`:

![Google Trends Web Search: elephant versus kidney](evidence/frequency/v0.10.0_frequency_google_trends_web_elephant_kidney_2026-05-13_REFERENCE_ONLY.png)

Figure 2. Google Trends Image Search, `elephant` versus `kidney`:

![Google Trends Image Search: elephant versus kidney](evidence/frequency/v0.10.0_frequency_google_trends_image_elephant_kidney_2026-05-13_REFERENCE_ONLY.png)

Figure 3. Google Books Ngram Viewer, `elephant` versus `kidney`:

![Google Books Ngram: elephant versus kidney](evidence/frequency/v0.10.0_frequency_google_books_ngram_elephant_kidney_2026-05-13_REFERENCE_ONLY.png)
...
https://github.com/ShuhanCS/medicalemoji/tree/master/submissions/v0.10.0
...
https://github.com/ShuhanCS/medicalemoji/blob/master/submissions/v0.10.0/v0.10.0_kidney_emoji_proposal_SUBMIT.md

Current source manifest:
https://github.com/ShuhanCS/medicalemoji/blob/master/submissions/v0.10.0/manifest.md
