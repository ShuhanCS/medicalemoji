...
| --- | --- | --- |
| `v2.2.1_kidney_emoji_proposal_SUBMIT.md` | `SUBMIT` | PDF-facing proposal source. |
| `v2.2.1_kidney_emoji_proposal_SUBMIT.pdf` | `SUBMIT` | Rendered PDF. Not yet hosted at a public URL. |
...
| `v2.2.1_support_letters_REFERENCE_ONLY.md` | `REFERENCE_ONLY` | The 13 institutional support letters, retained but kept out of the proposal. |
