...
**Suggested keywords:** hepatic; anatomy; organ; metabolism; digestion; bile; alcohol; hepatitis; transplant; donation<br>
...
This proposal does not request a complete anatomy taxonomy. Liver is supported by its own frequency, breadth of direct uses, visual distinctiveness, and lack of an adequate substitute. Other organs can be judged independently on the same criteria.
...
The proposal does not argue that liver should be encoded merely because other organs exist. Its case rests on its own expected usage, breadth of direct uses, recognizable silhouette, and expressive gap.
