# Medical Emoji Submission Package v1.12.0-kidney.3

Package version: 1.12.0-kidney.3

Created: 2026-07-26

Status: **Isolated Kidney rubric-alignment prerelease; NOT READY TO SUBMIT.**
...
| Component | Component version/provenance | Status in v1.12.0-kidney.3 |
| --- | --- | --- |
...
| Best-in-class rubric | Rubric 3.1.0 | Current section-by-section drafting and plain-language standard recorded |
| White Blood Cell | Submission package v1.9.0 | Complete folder carried forward byte for byte; evidence-gated draft |
| Kidney | Prerelease v1.12.0-kidney.3 | Ten-author byline preserved; proposal aligned to rubric 3.1.0; page-one rights and reviewer-facing prose corrected; Lungs comparison remains open internally |
...
| Artwork license | Package 1.12.0-kidney.3 | Kidney and Stomach AI-assisted concept provenance and project-authored submission assets recorded |

Folder layout:

```text
submissions/v1.12.0-kidney.3/
|-- VERSION
|-- manifest.md
|-- CHANGELOG.md
|-- ARTWORK-LICENSE.md
...
- Kidney: resolve the open Lungs IoU warning without weakening the declared threshold, archive eligibility and
  duplicate-coordination evidence, publish the exact PDF, reconcile the form, and promote the accepted paired
  artwork into a canonical snapshot.
