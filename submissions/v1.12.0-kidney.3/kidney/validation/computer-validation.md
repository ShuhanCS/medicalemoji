...
| --- | --- | ---: | ---: | --- |
| color_18x18 | anatomical heart | 0.558 | 29 | PASS |
| color_18x18 | balloon | 0.471 | 30 | PASS |
| color_18x18 | beans | 0.684 | 27 | PASS |
| color_18x18 | droplet | 0.469 | 30 | PASS |
| color_18x18 | light bulb | 0.446 | 30 | PASS |
| color_18x18 | lungs | 0.750 | 23 | FAIL |
| bw_18x18 | anatomical heart | 0.481 | 25 | PASS |
| bw_18x18 | balloon | 0.318 | 32 | PASS |
| bw_18x18 | beans | 0.508 | 27 | PASS |
| bw_18x18 | droplet | 0.403 | 26 | PASS |
| bw_18x18 | light bulb | 0.364 | 28 | PASS |
| bw_18x18 | lungs | 0.563 | 25 | PASS |
...
python scripts/validate_kidney_artwork.py `
  --proposal-dir submissions/v1.12.0-kidney.3/kidney `
  --json-output submissions/v1.12.0-kidney.3/kidney/validation/computer-validation.json `
  --markdown-output submissions/v1.12.0-kidney.3/kidney/validation/computer-validation.md
```
