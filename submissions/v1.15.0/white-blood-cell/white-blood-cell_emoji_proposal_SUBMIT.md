...
No existing emoji or sequence identifies a white blood cell. Microbe + Shield can suggest generic protection
from a germ, but it cannot identify the body's own defense cell or contrast the invader with the body's
response. Drop of Blood, Test Tube, Microscope, and Hospital provide context without expressing the immune
system itself or communicating a low, high, or recovering white-cell count.
