# Medical Emoji Submission Package v1.15.0
...
| Component | Component version/provenance | Status in v1.15.0 |
| --- | --- | --- |
...
| White Blood Cell | Submission package v1.15.0 | Body-defense meaning leads; Microbe is the germ/threat counterpart; science uses are secondary |
...
| Artwork license | Package v1.15.0 | Image rights unchanged; White Blood Cell art carried forward from v1.14.0 |
...
This snapshot copies v1.14.0 and changes only the reviewer-facing White Blood Cell proposal and PDF, helper
