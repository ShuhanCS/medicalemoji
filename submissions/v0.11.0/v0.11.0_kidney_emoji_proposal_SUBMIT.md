...
![Kidney color 18x18](images/v0.11.0_kidney_color_18x18_SUBMIT.png)

Color 72x72:

![Kidney color 72x72](images/v0.11.0_kidney_color_72x72_SUBMIT.png)

Black-and-white 18x18:

![Kidney black-and-white 18x18](images/v0.11.0_kidney_bw_18x18_SUBMIT.png)

Black-and-white 72x72:

![Kidney black-and-white 72x72](images/v0.11.0_kidney_bw_72x72_SUBMIT.png)
...
![Kidney 18x18 visual review board](evidence/visual-review/v0.11.0_18x18_visual_review_board_SUBMIT.png)
...
Expected usage is supported by public search-interest and corpus evidence. The following figures compare `kidney` with `elephant` for Google Trends and Google Books Ngram evidence.

Figure 1. Google Trends Web Search, `elephant` versus `kidney`:

![Google Trends Web Search: elephant versus kidney](evidence/frequency/v0.11.0_frequency_google_trends_web_elephant_kidney_2026-05-13_SUBMIT.png)

Figure 2. Google Trends Image Search, `elephant` versus `kidney`:

![Google Trends Image Search: elephant versus kidney](evidence/frequency/v0.11.0_frequency_google_trends_image_elephant_kidney_2026-05-13_SUBMIT.png)

Figure 3. Google Books Ngram Viewer, `elephant` versus `kidney`:

![Google Books Ngram: elephant versus kidney](evidence/frequency/v0.11.0_frequency_google_books_ngram_elephant_kidney_2026-05-13_SUBMIT.png)
