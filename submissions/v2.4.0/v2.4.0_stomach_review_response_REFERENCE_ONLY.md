...
`submissions/v2.3.0/`. Packet v2.3.1 later added verified Microsoft titles; v2.4.0 then restructured the public
proposal for the May 2026 template and added the CLDR interoperability case. The findings below remain a
historical record, not a review of v2.4.0.
