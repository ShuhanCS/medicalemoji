...
| --- | --- | --- |
| 18x18 | ![Kidney color 18x18](images/v2.4.0_kidney_color_18x18_SUBMIT.png) | ![Kidney black-and-white 18x18](images/v2.4.0_kidney_bw_18x18_SUBMIT.png) |
| 72x72 | ![Kidney color 72x72](images/v2.4.0_kidney_color_72x72_SUBMIT.png) | ![Kidney black-and-white 72x72](images/v2.4.0_kidney_bw_72x72_SUBMIT.png) |
...
![Google Search results for kidney](evidence/frequency/v2.4.0_kidney_google_search_2026-05-13_SUBMIT.png)
...
![Google Video Search results for kidney](evidence/frequency/v2.4.0_kidney_google_video_search_2026-05-13_SUBMIT.png)
...
![Google Trends Web Search for elephant and kidney](evidence/frequency/v2.4.0_kidney_google_trends_web_elephant_2026-05-13_SUBMIT.png)
...
![Google Trends Image Search for elephant and kidney](evidence/frequency/v2.4.0_kidney_google_trends_image_elephant_2026-05-13_SUBMIT.png)
...
![Google Books Ngram for elephant and kidney](evidence/frequency/v2.4.0_kidney_google_books_ngram_elephant_2026-07-09_SUBMIT.png)
...
No legacy carrier set is involved, but CLDR creates a live search-interoperability issue. Its documented emoji
search model populates results from user-entered keywords. Current English data assigns `kidney` only to
U+1FAD8 BEANS, whose short name is `beans`, while no encoded emoji depicts the organ. See the
[CLDR search model](https://cldr.unicode.org/downloads/cldr-46) and
[English annotations](https://github.com/unicode-org/cldr/blob/main/common/annotations/en.xml).

Encoding Kidney resolves the concept-to-character mismatch. Deleting the inaccurate Beans keyword would
change a misleading result into no kidney-organ result. Because CLDR assigns keywords, this proposal requests
no particular annotation change; it identifies the missing character needed for an accurate result.

Unicode's Emoji 19.0 priorities emphasize empirical use, compatibility with apps, standards, or operating
systems, and improvements for existing emoji users. The five frequency exhibits address the first; the CLDR
mismatch and demonstrated Beans ambiguity address the latter two. UTC #185 minutes record that compatibility
was the theme of the 2025 proposed set and that Monarch Butterfly would not have been recommended without its
compatibility rationale. This is process context, not a comparison between the characters. See
[L2/25-128](https://www.unicode.org/L2/L2025/25128-esr-priorities.pdf) and
[UTC #185 minutes](https://www.unicode.org/L2/L2025/25226.htm).
