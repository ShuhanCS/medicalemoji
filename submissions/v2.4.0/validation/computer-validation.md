...
Carried into packet `v2.4.0` on 2026-07-28. The four `v2.4.0_`-prefixed submission PNGs are
byte-identical to the July 26 files named below; only their synchronized packet filenames changed.
...
Original July 26 reproduction command:
