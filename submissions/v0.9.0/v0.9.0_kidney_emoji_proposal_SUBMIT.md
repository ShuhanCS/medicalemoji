...
![Kidney color 18x18](images/v0.9.0_kidney_color_18x18_SUBMIT.png)

Color 72x72:

![Kidney color 72x72](images/v0.9.0_kidney_color_72x72_SUBMIT.png)

Black-and-white 18x18:

![Kidney black-and-white 18x18](images/v0.9.0_kidney_bw_18x18_SUBMIT.png)

Black-and-white 72x72:

![Kidney black-and-white 72x72](images/v0.9.0_kidney_bw_72x72_SUBMIT.png)
...
| Image | Packet file | Repository link |
| --- | --- | --- |
| Color 18x18 | `images/v0.9.0_kidney_color_18x18_SUBMIT.png` | https://github.com/ShuhanCS/medicalemoji/blob/master/submissions/v0.9.0/images/v0.9.0_kidney_color_18x18_SUBMIT.png |
| Color 72x72 | `images/v0.9.0_kidney_color_72x72_SUBMIT.png` | https://github.com/ShuhanCS/medicalemoji/blob/master/submissions/v0.9.0/images/v0.9.0_kidney_color_72x72_SUBMIT.png |
| Black-and-white 18x18 | `images/v0.9.0_kidney_bw_18x18_SUBMIT.png` | https://github.com/ShuhanCS/medicalemoji/blob/master/submissions/v0.9.0/images/v0.9.0_kidney_bw_18x18_SUBMIT.png |
| Black-and-white 72x72 | `images/v0.9.0_kidney_bw_72x72_SUBMIT.png` | https://github.com/ShuhanCS/medicalemoji/blob/master/submissions/v0.9.0/images/v0.9.0_kidney_bw_72x72_SUBMIT.png |
| Source artwork copy | `images/v0.9.0_kidney_artwork_SOURCE_REFERENCE_ONLY.png` | https://github.com/ShuhanCS/medicalemoji/blob/master/submissions/v0.9.0/images/v0.9.0_kidney_artwork_SOURCE_REFERENCE_ONLY.png |

Source artwork copy:

![Kidney source artwork copy](images/v0.9.0_kidney_artwork_SOURCE_REFERENCE_ONLY.png)

## 3. Factors For Inclusion

### A. Multiple Concepts

The kidney emoji represents a broad, durable, and widely understood concept rather than a single diagnosis, procedure, campaign, or profession. Its meanings extend beyond medicine. People use the word `kidney` in ordinary life for the body part, kidney beans, kidney-shaped objects, anatomy lessons, hydration, filtration, body functions, wellness, diet, cooking, donation, transplant, stones, urine, and health.

This matters because a kidney emoji would not be used only by clinicians, nephrology groups, or awareness campaigns. It would support ordinary communication about the human body, school science, food and recipes, body-function jokes, hydration reminders, fitness and wellness conversations, family health updates, donor and transplant conversations, patient education, and public-health messages.
...
https://github.com/ShuhanCS/medicalemoji/blob/master/submissions/v0.9.0/evidence/visual-review/v0.9.0_18x18_visual_review_board_REFERENCE_ONLY.png

![Kidney 18x18 visual review board](evidence/visual-review/v0.9.0_18x18_visual_review_board_REFERENCE_ONLY.png)
...
https://github.com/ShuhanCS/medicalemoji/tree/master/submissions/v0.9.0/evidence/frequency

Available draft evidence images included in this packet:

Google Trends Image Search, `elephant` versus `kidney`:

![Google Trends Image Search: elephant versus kidney](evidence/frequency/v0.9.0_frequency_google_trends_image_elephant_kidney_2026-05-13_REFERENCE_ONLY.png)

Google Books Ngram Viewer, `elephant` versus `kidney`:

![Google Books Ngram: elephant versus kidney](evidence/frequency/v0.9.0_frequency_google_books_ngram_elephant_kidney_2026-05-13_REFERENCE_ONLY.png)

Google Trends Web Search, partial capture only:

![Google Trends Web Search partial capture: elephant versus kidney](evidence/frequency/v0.9.0_frequency_google_trends_web_elephant_kidney_2026-05-13_REFERENCE_ONLY.png)

The final public PDF must insert fresh accepted screenshots for all five required evidence categories before filing. The current Google Search and Google Video Search screenshots are absent because automated capture returned CAPTCHA pages. The current Google Trends Web Search screenshot is included only to show the attempted capture; it must be replaced because the interest-over-time panel errored. Support letters, petitions, hashtags, and social-media requests are not used as frequency evidence.
...
https://github.com/ShuhanCS/medicalemoji/blob/master/submissions/v0.9.0/v0.9.0_kidney_emoji_proposal_SUBMIT.md

Current packet manifest:
https://github.com/ShuhanCS/medicalemoji/blob/master/submissions/v0.9.0/manifest.md
