# Medical Emoji Submission Package v1.14.0
...
| Component | Component version/provenance | Status in v1.14.0 |
| --- | --- | --- |
...
| White Blood Cell | Submission package v1.14.0 | Plain-language immunity, health, education, and science uses; specialist LOINC/HL7 material removed |
...
| Artwork license | Package v1.14.0 | Image rights unchanged; White Blood Cell art carried forward from v1.13.0 |
...
This snapshot copies v1.13.0 and changes only the reviewer-facing White Blood Cell proposal and PDF, helper
...
- Broader-usage review: immunity, personal health, education, public science, microscopy, and research uses are
  stated in plain language; LOINC and HL7 are removed from the reviewer-facing case.
