...
| Use in sequences | Pass | Gives four understandable combinations for infection response, immune defense, white-cell count, and biology or research. |
...
| Expected usage level | Pass | Connects immunity, personal health conversations, education, public science, microscopy, and research to institutional citations and five frequency exhibits. |
...
| Already represented | Pass | Addresses the strongest substitute, Microbe + Shield, and the immune-cell and white-cell-count meanings it cannot express. |
...
- Applied lesson: the v1.14.0 proposal leads with the missing host immune cell and white-cell-count meanings,
  uses direct `Not applicable.` answers, limits frequency comparisons to their evidentiary purpose, and removes
  generic case-building phrases and specialist standards terminology.
...
| ESR selection reviewer | READY FOR FINAL CHECK | The proposal defines a concrete host-immune-cell gap, gives genuine health, education, and science uses, interprets frequency evidence proportionately, and uses honest `Not applicable.` answers. |
| Community proposal mentor | READY FOR FINAL CHECK | An educated general reader can follow immunity, infection-response, blood-count, classroom, public-science, and research uses without specialist standards terminology. |
...
Shuhan He's prior approval and rights confirmation governs the unchanged four-artwork set carried from v1.13.0.
...
- Hyperlinks: 10 unique HTTPS destinations embedded.
...
- PDF SHA-256: `A9A07F4C9FFC70940BF497F7151AC44043ACEBC2A89C592D6A2EC119C599E3DE`.

## Publication record

Release commit: `8caac2d884ebdd2c415d31a4b18bfd21b66757fc`

Public PDF:

https://raw.githubusercontent.com/ShuhanCS/medicalemoji/8caac2d884ebdd2c415d31a4b18bfd21b66757fc/submissions/v1.14.0/white-blood-cell/white-blood-cell_emoji_proposal_SUBMIT.pdf

Logged-out verification: HTTP 200, `application/octet-stream`, 1,528,888 bytes; downloaded SHA-256 matches the
