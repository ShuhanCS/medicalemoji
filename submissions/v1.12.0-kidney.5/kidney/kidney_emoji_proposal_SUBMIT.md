...
Kidney names the organ in several distinct, established messages. MedlinePlus uses `kidney stone`,
...
[Hemodialysis](https://www.niddk.nih.gov/health-information/kidney-disease/kidney-failure/hemodialysis). The same
language is used outside the United States: NHS Blood and Transplant describes `kidney transplant tests` and
explains dialysis when kidneys cannot filter the body normally. See
