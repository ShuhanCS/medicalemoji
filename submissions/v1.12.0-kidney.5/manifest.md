# Medical Emoji Submission Package v1.12.0-kidney.5
...
| Component | Component version/provenance | Status in v1.12.0-kidney.5 |
| --- | --- | --- |
...
| Kidney | Prerelease v1.12.0-kidney.5 | Ten-author byline preserved; exact-hash panel edits adopted; proposal uses candidate-specific ordinary language and non-U.S. corroboration; artwork passes all fixed computer checks |
...
| Artwork license | Package 1.12.0-kidney.5 | Kidney and Stomach AI-assisted concept provenance and project-authored submission assets recorded |

Folder layout:

```text
submissions/v1.12.0-kidney.5/
|-- VERSION
|-- manifest.md
|-- CHANGELOG.md
|-- ARTWORK-LICENSE.md
...
specification. A further Kidney-only iteration creates `submissions/v1.12.0-kidney.6/`; accepted Kidney changes
