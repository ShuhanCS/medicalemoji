# Medical Emoji Submission Package v1.10.0

Package version: 1.10.0

Created: 2026-07-26

Status: **Kidney corrected publication candidate. Ready to publish; not yet filed.**
...
| Component | Component version/provenance | Status in v1.10.0 |
| --- | --- | --- |
...
The next substantive proposal correction after this snapshot will therefore create `submissions/v1.11.0/` by
copying all of v1.10.0 and changing only the reviewed proposal plus package control files.
