# Medical Emoji Submission Package v1.11.0-liver.1

Package version: 1.11.0-liver.1

Created: 2026-07-26

Status: **Liver correction prerelease. Revision required; not filed.**
...
| Component | Component version/provenance | Status in v1.11.0-liver.1 |
| --- | --- | --- |
...
| Kidney | Submission package v1.10.0 | Citations, computer validation, and PDF pagination corrected; ready to publish |
| Stomach | Submission package v1.9.0 | Complete folder carried forward byte for byte; revision required |
| Liver | Prerelease v1.11.0-liver.1 | Selection-factor language corrected and PDF rebuilt; evidence and validation gates remain |
| Artwork license | Package 1.8.0, carried through v1.9.0 | Carried forward byte for byte without expanding the rights record |

Folder layout:

```text
submissions/v1.11.0-liver.1/
|-- VERSION
|-- manifest.md
|-- CHANGELOG.md
|-- ARTWORK-LICENSE.md
...
This is an isolated prerelease lane, not a canonical package. The coordinator may apply the accepted Liver
delta to a future complete canonical snapshot without merging unrelated lane history.
...
- Kidney: publish the exact v1.10.0 PDF, reconcile the form, obtain final filing authorization, and archive the
  submission confirmation.
- Stomach: refresh four 2020 evidence captures and pass recognition/comparison review.
- Liver: the independent selection argument is corrected; replace four 2020 captures, including U.S.-only
  Trends, improve the small black-and-white paradigm, add citations and deterministic comparison validation,
  and obtain final publication and filing controls.
