...
| --- | --- | --- |
| 18x18 | ![Kidney color 18x18](images/v2.8.0_kidney_color_18x18_SUBMIT.png) | ![Kidney black-and-white 18x18](images/v2.8.0_kidney_bw_18x18_SUBMIT.png) |
| 72x72 | ![Kidney color 72x72](images/v2.8.0_kidney_color_72x72_SUBMIT.png) | ![Kidney black-and-white 72x72](images/v2.8.0_kidney_bw_72x72_SUBMIT.png) |
...
Kidney was captured 2026-05-13 in signed-out Google Web Search with English-language results and no date or
country filter selected. The page reports about 211,000,000 indexed results.
[Open the reproducible Kidney Google Search query](https://www.google.com/search?q=kidney&hl=en&num=10&pws=0).

![Google Search results for kidney](evidence/frequency/v2.8.0_kidney_google_search_2026-05-13_SUBMIT.png)

Elephant was captured 2026-07-28 with the same signed-out search type, language, and no date or country filter
selected. The page reports about 483,000,000 indexed results.
[Open the reproducible Elephant Google Search query](https://www.google.com/search?q=elephant&hl=en&num=10&pws=0&start=0&filter=0).

![Google Search results for elephant](evidence/frequency/v2.8.0_elephant_google_search_2026-07-28_SUBMIT.png)

Google's approximate index counts are volatile snapshots, but the required comparison is clear: Kidney has
about 211 million results against Elephant's 483 million, placing the proposed name at roughly 44% of the
comparison term in this source.

#### Google Video Search

Kidney was captured 2026-05-13 in signed-out Google Video Search with English-language results and no date or
country filter selected. The page reports about 66,000,000 indexed results.
[Open the reproducible Kidney Google Video Search query](https://www.google.com/search?tbm=vid&q=kidney&hl=en&num=10&pws=0).

![Google Video Search results for kidney](evidence/frequency/v2.8.0_kidney_google_video_search_2026-05-13_SUBMIT.png)

Elephant was captured 2026-07-28 with the same signed-out video-search type, language, and no date or country
filter selected. The page reports about 85,300,000 indexed results.
[Open the reproducible Elephant Google Video Search query](https://www.google.com/search?tbm=vid&q=elephant&hl=en&num=10&pws=0&start=0&filter=0).

![Google Video Search results for elephant](evidence/frequency/v2.8.0_elephant_google_video_search_2026-07-28_SUBMIT.png)

In the required Video comparison, Kidney has about 66 million results against Elephant's 85.3 million, or
roughly 77% of the comparison term. These counts are used only as the form's requested relative index measure,
...
![Google Trends Web Search for elephant and kidney](evidence/frequency/v2.8.0_kidney_google_trends_web_elephant_2026-05-13_SUBMIT.png)
...
![Google Trends Image Search for elephant and kidney](evidence/frequency/v2.8.0_kidney_google_trends_image_elephant_2026-05-13_SUBMIT.png)
...
![Google Books Ngram for elephant and kidney](evidence/frequency/v2.8.0_kidney_google_books_ngram_elephant_2026-07-09_SUBMIT.png)
