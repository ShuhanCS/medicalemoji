# Medical Emoji Submission Package v1.12.0-kidney.6

Package version: 1.12.0-kidney.6
...
| Component | Component version/provenance | Status in v1.12.0-kidney.6 |
| --- | --- | --- |
...
| Kidney | Prerelease v1.12.0-kidney.6 | Ten-author byline preserved; Expected usage tightened; strongest GPT Image 2 concept promoted at 72px; purpose-built 18px assets retained; all fixed computer checks pass |
...
| Artwork license | Package 1.12.0-kidney.6 | Kidney GPT Image 2 masters and exact exports plus Stomach artwork provenance recorded |

Folder layout:

```text
submissions/v1.12.0-kidney.6/
|-- VERSION
|-- manifest.md
|-- CHANGELOG.md
|-- ARTWORK-LICENSE.md
...
specification. A further Kidney-only iteration creates `submissions/v1.12.0-kidney.7/`; accepted Kidney changes
