# Medical Emoji Proposal Release v1.3.0

Release date: 2026-07-10

This release contains nine independent proposal packets for re-eligible Medical Emoji portfolio concepts. Eight were last submitted in 2020; Inhaler was submitted in 2018. All nine are outside Unicode's stated four-year resubmission window by the 2026-07-31 intake deadline.

| Proposal | Packet status | Proposal PDF | Remaining filing work |
| --- | --- | --- | --- |
| CT Scan | Complete packet | `ct-scan/ct-scan_emoji_proposal_SUBMIT.pdf` | Refresh 2020 Search, Video, and Trends captures if a clean session is available |
...
| Pill Pack | Evidence-gated draft | `pill-pack/pill-pack_emoji_proposal_DRAFT.pdf` | Add Web Trends and replace archived Image Trends comparator with `elephant` |

Every concept includes:

- A standalone proposal answering every current inclusion and exclusion factor.
- Color and true black-and-white PNGs at 18x18 and 72x72.
- Editable SVG source artwork.
- Original, textless art released under CC0 1.0 in `ARTWORK-LICENSE.md`.
- Restored historical Google Search and Video evidence where available, with honest capture dates and gaps labeled explicitly.
- A fresh Google Books Ngram comparison against `elephant`, captured 2026-07-10.

## Portfolio recommendation

Do not file all nine. Eligibility only determines what may be considered; it does not establish distinctiveness, expected usage, or a coherent portfolio.
...
1. Confirm the selected concept and packet with the Microsoft Unicode, product, design, and legal owners.
2. Capture any missing Google Trends charts in a clean manual browser session using `elephant`, Worldwide, 2004-present for Web Search and 2008-present for Image Search.
3. Prefer fresh Search, Video, and Trends captures for the final selected proposal; retain the archived files as a traceable historical record.
4. Rebuild and visually inspect the selected PDF after any evidence replacement.
5. Have Shuhan He accept the Unicode Emoji Proposal Agreement and License and file as the individual submitter.
