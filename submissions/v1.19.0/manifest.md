...
Status: **White Blood Cell v1.19.0 release candidate; publication record pending.**
...
| White Blood Cell | Submission package v1.19.0 | Google Search count corrected to about 880,000,000; Usage level, Multiple meanings, Distinctiveness figure, and Prior submission note revised |
...
| Artwork license | Package v1.19.0 | White Blood Cell artwork carried unchanged from v1.17.0 under CC0; recognition figure is original to this proposal |
