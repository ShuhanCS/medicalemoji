# Medical Emoji Submission Package v1.19.0
...
| Component | Component version/provenance | Status in v1.19.0 |
| --- | --- | --- |
...
| White Blood Cell | Submission package v1.19.0 | Elongated connected nucleus replaces radial arrangement |
...
| Artwork license | Package v1.19.0 | Revised White Blood Cell masters released under CC0 |
...
This snapshot copies v1.18.0 and changes the White Blood Cell colour and true black-and-white artwork, the
reviewer-facing image explanation and design guidance, deterministic validation output, helper usage examples,
and package control files. The rubric, five mandatory frequency exhibits, Kidney, Stomach, Liver, template, and
internal comparator sources remain unchanged.
...
- Artwork review: the folded membrane and elongated connected three-lobed nucleus remain legible at 18x18 in
