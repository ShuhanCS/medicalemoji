...
proposal for the May 2026 template and added the CLDR interoperability case; v2.4.1 compressed only the PDF
layout. The findings below remain a historical record, not a review of v2.4.1.
