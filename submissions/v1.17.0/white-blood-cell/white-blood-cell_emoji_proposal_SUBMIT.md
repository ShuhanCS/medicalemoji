...
**Keywords:** immunity; defense; infection; health; leukocyte<br>
...
softly irregular cell body with one connected, multi-lobed nucleus - as the visual model for the broader
...
White Blood Cell is shown as a pale, softly irregular cell with one large, connected, asymmetric three-lobed
center, or nucleus. At 18 pixels, the folded outline and segmented center distinguish it from Microbe's spiked
edge, Drop of Blood's teardrop shape, and a generic cell's simple circular interior. The same cues remain clear
in colour and black and white. Vendors may vary the outline, lobe count, colour, and shading while preserving
the pale cell body and single connected lobed center.
...
At 18x18, fine microscopic detail should yield to legibility. Radiating spikes should be avoided because they
imply Microbe, and the nucleus should remain a single connected feature rather than a face-like arrangement.
The character name should remain White Blood Cell rather than a leukocyte subtype.
