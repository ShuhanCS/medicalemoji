# Medical Emoji Submission Package v1.12.0-kidney.2
...
| Component | Component version/provenance | Status in v1.12.0-kidney.2 |
| --- | --- | --- |
...
| Kidney | Prerelease v1.12.0-kidney.2 | David Rhew and Heena Purohit explicitly preserved as co-authors and submitters with sourced Microsoft affiliations; paired artwork and open computer gate carried forward |
...
specification. A further Kidney-only iteration creates `submissions/v1.12.0-kidney.3/`; accepted Kidney changes
