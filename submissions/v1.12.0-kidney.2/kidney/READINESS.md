...
David Rhew and Heena Purohit are explicitly identified as individual co-authors and submitters in the proposal.
Their current Microsoft affiliations are supported by public institutional sources: the World Medical Innovation
Forum identifies David Rhew as Global Chief Medical Officer and VP Healthcare at Microsoft, and Microsoft's
official author profile identifies Heena Purohit as Director of AI Startups at Microsoft for Startups.
...
| Authorship | Pass | Consent is confirmed for all ten submitters; David Rhew and Heena Purohit are explicitly identified as individual co-authors and submitters. |
| Author affiliations | Pass | Current public institutional sources verify David Rhew's Microsoft healthcare leadership role and Heena Purohit's Director of AI Startups role at Microsoft for Startups. |
...
## Changes in 1.12.0-kidney.2

- Preserves David Rhew and Heena Purohit as individual co-authors and submitters in the proposal's filing header.
- Adds their current Microsoft affiliations and authoritative public source URLs.
- Rebuilds the PDF so the authorship confirmation appears in the submission artifact.

## Changes carried from 1.12.0-kidney.1
