...
python scripts/validate_kidney_artwork.py `
  --proposal-dir submissions/v1.12.0-kidney.2/kidney `
  --json-output submissions/v1.12.0-kidney.2/kidney/validation/computer-validation.json `
  --markdown-output submissions/v1.12.0-kidney.2/kidney/validation/computer-validation.md
```
