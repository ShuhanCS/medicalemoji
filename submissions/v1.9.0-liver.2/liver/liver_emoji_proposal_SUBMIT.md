...
**Suggested keywords:** hepatic; anatomy; organ; bile; digestion; abdomen; lobes<br>
...
![Color visual-confusion board at 18x18](evidence/visual-review/liver_comparison_color_18x18.png)

![Black-and-white visual-confusion board at 18x18](evidence/visual-review/liver_comparison_bw_18x18.png)
...
Captured 2026-07-24 using Google's Web-results view. Google currently hides its native result-stat element in a
zero-layout area, but the live page supplied `About 194,000 results (0.26s)` in `#result-stats`. The linked
evidence screenshot reveals that exact DOM-provided value in a labeled overlay; it does not alter the query,
result set, or result-stat text.

Query: https://www.google.com/search?udm=14&q=liver&hl=en&num=10&pws=0

![Google Search result stats for liver](evidence/frequency/liver_google_search_2026-07-24_RESULT_STATS_REVEALED.jpg)

#### Google Video Search

Captured 2026-07-24 using Google's Video-results view. Google currently hides its native result-stat element in
a zero-layout area, but the live page supplied `About 82,000,000 results (0.38s)` in `#result-stats`. The linked
evidence screenshot reveals that exact DOM-provided value in a labeled overlay; it does not alter the query,
result set, or result-stat text.

Query: https://www.google.com/search?udm=7&q=liver&hl=en&num=10&pws=0

![Google Video Search result stats for liver](evidence/frequency/liver_google_video_search_2026-07-24_RESULT_STATS_REVEALED.jpg)
...
![Google Trends Worldwide Web Search for liver and elephant](evidence/frequency/liver_google_trends_web_elephant_2026-07-21_SUBMIT.png)
...
![Google Trends Worldwide Image Search for liver and elephant](evidence/frequency/liver_google_trends_image_elephant_2026-07-21_SUBMIT.png)
...
![Google Books Ngram for elephant and liver](evidence/frequency/liver_google_books_ngram_elephant_2026-07-21_SUBMIT.png)

The 2026 captures were obtained in an unsigned browser session. Full URLs, dates, ranges, locations, modes,
filters, and result-stat extraction behavior are recorded above and in the evidence notes.
...
not treat Liver as precedent for adding every internal organ. Other candidates require their own evidence and
recognizable paradigms.
