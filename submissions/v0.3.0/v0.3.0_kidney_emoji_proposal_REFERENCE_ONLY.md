...
Important draft note: this Markdown draft uses placeholders where the final Unicode PDF must include images, image-rights certification, usage-frequency screenshots, final submitter approvals, and a public PDF URL. The final submitted proposal must remove this note.
...
The final proposal must include color and black-and-white example images at both 18x18 and 72x72 pixels at the top of the first page.

Image placeholders for the final PDF:

| Required image | Status |
| --- | --- |
| Color 18x18 | TODO: insert final original image |
| Color 72x72 | TODO: insert final original image |
| Black-and-white 18x18 | TODO: insert final original image |
| Black-and-white 72x72 | TODO: insert final original image |

Image rights/license statement placeholder:

> The submitter certifies that the proposed emoji images are original works owned by the submitter, works made for hire, assigned to the submitter, or otherwise available under an appropriate open license or public-domain designation. Final rights documentation and any required source URL will be inserted before submission.

The final image should represent the kidney as a recognizable human organ, not as a medical society logo, campaign mark, device icon, or exact vendor request. The most important design risk is confusion with beans. The final art should therefore use a silhouette, paired arrangement, hilum, vessel, ureter, or other simple anatomical cue only to the extent that it improves recognition at 18x18. Any detail that makes the small image visually noisy should be removed.

Historical project art exists at:
https://medicalemoji.org/documents/kidney-support-letters/kidneysnew2.png

That image is useful as design history only. It should not be used in the final proposal unless the rights chain is confirmed and the submitter can make Unicode's required image-rights warranty.
...
The proposal does not depend on the argument that heart, lungs, or brain already exist. Those emoji are useful context, but the kidney case stands on independent grounds: the kidney is a visually iconic organ with high public-health salience, broad clinical and everyday uses, and several communication contexts that existing emoji cannot express clearly. A bean emoji is not a practical substitute. In medical, patient-facing, transplant, donation, and public-health contexts, a bean can be confusing, unserious, or simply wrong.

### D. Distinctiveness

The kidney has a recognizable anatomical form: a curved bean-like shape, a medial indentation, and a common paired-organ presentation. That visual familiarity gives the emoji a strong basis for recognition, but it also creates the main design challenge. At small size, the image must read as a kidney rather than a bean, generic red shape, or food item.

The final proposal should include a simple visual test next to the bean emoji and existing anatomical emoji. The test should show that the kidney remains legible at 18x18 and 72x72 in both color and black-and-white. The final art should avoid text labels, logos, excessive internal detail, and any exact vendor-specific rendering. If a paired-kidney design is more recognizable than a single-kidney design, the final proposal should use the paired design. If a single kidney is cleaner at 18x18, the proposal should explain that the singular image still represents the organ concept as a whole.

Evidence still required for this section:

- Final 18x18 and 72x72 color images.
- Final 18x18 and 72x72 black-and-white images.
