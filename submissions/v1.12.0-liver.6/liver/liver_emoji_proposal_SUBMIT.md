...
**Authors:** Shuhan He, MD; David Rhew, MD; Heena Purohit; Adrienne Balk<br>
...
**Suggested keywords:** hepatic; anatomy; organ; laboratory test; medicine safety; transplant; donation<br>
...
NIDDK documents liver transplantation and living donors. The five required figures below measure search
interest and published-word frequency, not demand for an emoji. They show worldwide Web interest comparable
to `elephant`, lower but sustained worldwide Image Search interest, and substantially higher recent
English-language published-word frequency.
...
Liver is the exact organ noun in the sourced phrases “liver function tests,” medicines that “affect the liver,”
and “liver transplant.” Current emoji can express a test, medicine, warning, hospital, or people but cannot
identify which organ those messages concern. This proposal encodes that reusable whole-organ referent, not any
test result, disease, procedure, or anatomy category.
...
Anatomical Heart, Lungs, and Brain are visual and sorting references only; their encoding is not evidence for
this proposal. The case rests on Liver's sourced messages, measured word use and search interest, and design.
