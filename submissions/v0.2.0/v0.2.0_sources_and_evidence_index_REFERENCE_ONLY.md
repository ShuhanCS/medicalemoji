# Kidney Emoji v0.2.0 Sources And Evidence Index
...
Save screenshots under the packet version where they are first added, for example:

`submissions/v0.3.0/evidence/`
