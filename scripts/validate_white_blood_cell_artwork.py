...
Usage:
    python scripts/validate_white_blood_cell_artwork.py \
        ...
        --json-output submissions/v1.12.0/white-blood-cell/validation/computer-validation.json \
        --markdown-output submissions/v1.12.0/white-blood-cell/validation/computer-validation.md
"""
