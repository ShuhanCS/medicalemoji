...
- `submissions/v1.2.0/manifest.md`
- `submissions/v1.2.0/v1.2.0_kidney_emoji_proposal_SUBMIT.md`
- `submissions/v1.2.0/v1.2.0_kidney_emoji_proposal_SUBMIT.pdf`
- `submissions/v1.2.0/v1.2.0_submission_finalization_SIGNATURE_REQUIRED.md`
- `submissions/v1.2.0/images/v1.2.0_kidney_color_18x18_SUBMIT.png`
- `submissions/v1.2.0/images/v1.2.0_kidney_color_72x72_SUBMIT.png`
- `submissions/v1.2.0/images/v1.2.0_kidney_bw_18x18_SUBMIT.png`
- `submissions/v1.2.0/images/v1.2.0_kidney_bw_72x72_SUBMIT.png`
- `submissions/v1.2.0/evidence/visual-review/v1.2.0_18x18_visual_review_board_SUBMIT.png`
