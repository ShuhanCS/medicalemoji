...
| **Stomach** | [`1.13.0-candidate.2`](docs/proposals/stomach-emoji-2026/candidate-v1.13/); confirmed eligible | **High - strongest semantic fit** | Literal organ, appetite and sensation, the verb `stomach`, established idioms, and clear sequence uses; the J-shaped silhouette is the clearest organ read at 18px; all five required frequency exhibits now include the `elephant` baseline | No compatibility case; written coauthor consent, exact-art approval, canonical promotion, publication, and filing controls remain open | **Lead filing; close consent, exact-art, promotion, publication, authorization, and form gates** |
...
| Stomach | Planned 2026 lead filing | `Stomach` declined 2020-10-27; `Stomach` declined 2022-07-28; private decline notice 2022-11-04 | Confirmed eligible for 2026 | 2022 | After 2026-11-04 by date alone; separately confirmed eligible | Finalize `1.13.0-candidate.2`: archive coauthor consent, obtain exact-art approval, promote, publish, reconcile the form, and file after authorization. |
