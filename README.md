...
- `submissions/v2.1.0/manifest.md`
- `submissions/v2.1.0/v2.1.0_kidney_emoji_proposal_SUBMIT.md`
- `submissions/v2.1.0/v2.1.0_kidney_emoji_proposal_SUBMIT.pdf`
- `submissions/v2.1.0/v2.1.0_submission_finalization_SIGNATURE_REQUIRED.md`
...
- `submissions/v2.1.0/evidence/visual-review/v2.1.0_18x18_visual_review_board_SUBMIT.png`
