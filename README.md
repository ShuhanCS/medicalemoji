...
- `submissions/v2.0.0/manifest.md`
- `submissions/v2.0.0/v2.0.0_kidney_emoji_proposal_SUBMIT.md`
- `submissions/v2.0.0/v2.0.0_kidney_emoji_proposal_SUBMIT.pdf`
- `submissions/v2.0.0/v2.0.0_submission_finalization_SIGNATURE_REQUIRED.md`
- `submissions/v2.0.0/images/v2.0.0_kidney_color_18x18_SUBMIT.png`
- `submissions/v2.0.0/images/v2.0.0_kidney_color_72x72_SUBMIT.png`
- `submissions/v2.0.0/images/v2.0.0_kidney_bw_18x18_SUBMIT.png`
- `submissions/v2.0.0/images/v2.0.0_kidney_bw_72x72_SUBMIT.png`
- `submissions/v2.0.0/evidence/visual-review/v2.0.0_18x18_visual_review_board_SUBMIT.png`
