...
- Current complete versioned package: [`submissions/v1.9.0/`](submissions/v1.9.0/)
...
that did not change are copied forward byte for byte. The next substantive proposal revision will be v1.10.0.

Authorship is fixed for the filing slate: Kidney uses the complete ten-person author list in v1.9.0, adding
