...
- Current complete versioned package: [`submissions/v1.17.0/`](submissions/v1.17.0/)
...
that did not change are copied forward byte for byte. The current substantive proposal revision is v1.17.0.
